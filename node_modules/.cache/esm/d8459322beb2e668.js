let assert,Library,Book;_beb‍.w("assert",[["default",["assert"],function(v){assert=v}]]);_beb‍.w("../library",[["default",["Library"],function(v){Library=v}]]);_beb‍.w("../book",[["default",["Book"],function(v){Book=v}]]);
